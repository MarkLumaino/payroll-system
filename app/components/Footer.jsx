...
return(
 <footer class="bg-[#020b1b] text-center text-white py-10">
    <div class="flex flex-col items-center gap-4">

        <div class="flex items-center gap-2">
            <img src="https://rocksontech.com/wp-content/uploads/2024/12/RS_LOGO_LANDSCAPE_WHITE.svg" alt="Rockson Logo" class="h-15"/> 
        </div>

        <a href="mailto:contact@rocksontech.com" 
           class="text-sm flex items-center gap-2 hover:text-blue-400 transition">
